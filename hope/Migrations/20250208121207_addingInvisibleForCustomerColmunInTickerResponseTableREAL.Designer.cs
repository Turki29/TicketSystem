...
namespace TicketSystem.Migrations
{
    ...
    [Migration("20250208121207_addingInvisibleForCustomerColmunInTickerResponseTableREAL")]
    partial class addingInvisibleForCustomerColmunInTickerResponseTableREAL
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TicketSystem.Models.Ticket", b =>
                {
                    ...
                    b.Property<byte>("RelativeWeight")
                    ...
                    b.Property<DateTime?>("TechResponseAt")
                        .HasColumnType("datetime2");

                    b.Property<string>("TechnicalIdentityUserId")
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("TechnicalResponse")
                        .HasColumnType("nvarchar(max)");

                    b.Property<DateTime>("TicketAssignDate")
                        .HasColumnType("datetime2");
                    ...
                    b.HasIndex("SenderIdentityUserId");
            ...
            modelBuilder.Entity("TicketSystem.Models.Ticket", b =>
                {
                    ...
                    b.HasOne("Microsoft.AspNetCore.Identity.IdentityUser", "SenderIdentityUser")
                        .WithMany()
                        .HasForeignKey("SenderIdentityUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Microsoft.AspNetCore.Identity.IdentityUser", "TechnicalIdentityUser")
                        .WithMany()
                        .HasForeignKey("TechnicalIdentityUserId");
